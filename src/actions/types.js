...
export const ACTION_APPLY_DESTINATION = 'ACTION_APPLY_DESTINATION';
export const ACTION_SELECT_DRIVE = 'ACTION_SELECT_DRIVE';
export const ACTION_DEVICE_NOT_FOUND = 'ACTION_DEVICE_NOT_FOUND';
