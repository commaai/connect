...
<!-- MUI AppBar position="sticky" elevation={1} -->
<header
  class="sticky top-0 z-30 flex flex-row flex-wrap items-center justify-between bg-[#1D2225] p-[7.5px]
         border-b border-white/10 shadow-[0_2px_4px_-1px_rgba(0,0,0,0.2),0_4px_5px_0_rgba(0,0,0,0.14),0_1px_10px_0_rgba(0,0,0,0.12)]"
>
